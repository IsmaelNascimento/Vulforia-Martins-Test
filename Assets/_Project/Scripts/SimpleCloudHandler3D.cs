...
/// </summary>
public class SimpleCloudHandler3D : MonoBehaviour, ICloudRecoEventHandler
{
    #region Variables
    ...
    public void OnNewSearchResult(TargetFinder.TargetSearchResult targetSearchResult)
    {
        ...
        newImageTarget.transform.GetChild(0).gameObject.SetActive(false);
        GameManager.Instance.m_Models3D.transform.SetParent(newImageTarget.transform);
